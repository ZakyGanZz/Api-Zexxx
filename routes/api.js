...
var creatorList = ['@mszpros','@hansdev','@hansdeveloper'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/62895336253039 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------HansGantengBanget'+'HANS--GANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'HansApi') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'HansApi') return res.json(loghandler.invalidKey)
